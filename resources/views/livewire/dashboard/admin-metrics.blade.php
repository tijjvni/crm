<div class="flex-col my-2">
    ...
    <div class="flex flex-wrap space-y-2 space-x-2">
        <div class=" flex-1 flex-col-1 divide-y divide-gray-light bg-white rounded-md shadow self-center">
            ...
            <div class="flex p-2 bg-gray-50 text-primary h-8 rounded-b-md items-end">
                <p class="text-primary text-sm">Create new</p>
            </div>
        </div>
        <div class=" flex-1 flex-col-1 divide-y divide-gray-light bg-white rounded-md shadow self-center">
            <div class="flex-col space-y-1 py-4 px-2 h-24">
            ...
            <div class="flex p-2 bg-gray-50 text-primary h-8 rounded-b-md items-end">
                <p class="text-primary text-sm">Grant permission</p>
            </div>
        </div>
        <div class=" flex-1 flex-col-1 divide-y divide-gray-light bg-white rounded-md shadow self-center">
            <div class="flex-col space-y-1 py-4 px-2 h-24">
